...
def get_posts():
    ...
    try:
        ...
        for post in posts:
            ...
            post["count_star"] = db.star.count_documents({
                "post_id": post["_id"], 
                "type": "star"
            })

            post["count_thumbsup"] = db.thumbsup.count_documents({
                "post_id": post["_id"], 
                "type": "thumbsup"
            })

            post["heart_by_me"] = bool(db.likes.find_one({"post_id": post["_id"], "type": "heart", "username": payload.get('id')}))
            post["star_by_me"] = bool(db.star.find_one({"post_id": post["_id"], "type": "star", "username": payload.get('id')}))
            post["thumbsup_by_me"] = bool(db.thumbsup.find_one({"post_id": post["_id"], "type": "thumbsup", "username": payload.get('id')}))
